				...
				<div class="row">
					<div class="col-lg-12 col-md-12 mt-5">
										...
										<div class="row justify-content-center card alert-danger">
												<div class="container mt-3 mx-3">
													<div class="alert-danger">
              											...
              											<a href="<?= base_url('Daftar_PWC') ?>" class="container primary-btn rounded py-1"><f style="font-size:17px;">Kembali Daftar</f></a>
																</div>
															</blockquote>
													</div>
												</div> 
            			...
            			<div class="testi_item">
            				<img style="position: relative;" class="bukti-daftar img-fluid" src="<?= base_url()?>assets/img/pwc/failed.png">
            			</div>
								</div>
							</div>
					</div>
