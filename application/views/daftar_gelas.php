			...
			<div class="section-top-border">
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<div class="row">
							<div class="col-md-7">
								<form action="<?= base_url() ?>DaftarGelas/add_gs" method="post" enctype="multipart/form-data">
									<div class="col-md-12">
							...
							<div class="col-md-5">
								<img class="img-fluid col-lg-12 col-md-6" src="<?= base_url() ?>assets/img/banner/form-2.png">
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
						...
						<div class="col-md-12 text-center">
							<input class="genric-btn primary circle e-large mt-3" type="submit" value="Daftar" name="TambahGS" style="font-size: 25px;"></input>
						</div>
						</form>
					</div>
				</div>
